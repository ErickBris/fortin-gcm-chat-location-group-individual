...
//		if (id == R.id.newchat) {
//
//			Intent i = new Intent(MyMessageActivity.context,
...
//
//			Intent i = new Intent(MyMessageActivity.context, AddGroup.class);
//			finish();
//			startActivity(i);
//			return true;
//		}else if (id == R.id.blockusers) {
//
//			Intent i = new Intent(MyMessageActivity.context, BlockedUsers.class);
//			finish();
//			startActivity(i);
//			return true;
...
//			else
//			{
//				Toast.makeText(getApplicationContext(), "You can not update profile as you have loggedin using "+logintype, Toast.LENGTH_LONG).show();
//			}
//			return true;
//		}
	...
	public class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View v, ViewGroup parent) {
			...
			if (logintype.equals("google")) {
				...
				String googleurl = dbuser.getprofileurl(userid);
			...
			}else if(logintype.equals("group")){
